...
if __name__ == '__main__':
    ...
    database_path='/data/DL/Adversarial/ActivityNet/Crawler/Kinetics/database/test/'
    tfrecord_dist_path='/home/ubadmin/pony/database/Kinetics/tfrecord_uint8/test/all_cls_shuffle/'

    main_random_videos(database_path,'all',tfrecord_dist_path)