...
video_list_path = [x.strip() for x in open('/data/DL/Adversarial/ActivityNet/Crawler/Kinetics/database/train_path_list.txt')]#'/media/ROIPO/Data/projects/Adversarial/kinetics-downloader/dataset/train/triple_jump/'
...
tf_dst_folder = '/data/DL/Adversarial/ActivityNet/Crawler/Kinetics/database/tfrecord/train/'
