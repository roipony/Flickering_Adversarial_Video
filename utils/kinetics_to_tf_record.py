...
video_base_path = '/data/DL/Adversarial/kinetics-downloader/dataset/train/juggling_balls/'#'/media/ROIPO/Data/projects/Adversarial/kinetics-downloader/dataset/train/triple_jump/'
...
tf_dst_folder = '/data/DL/Adversarial/kinetics-i3d/data/tfrecords/juggling_balls_90_frames/train/'
...
for i, v in enumerate(video_list_path):
    if i%10 ==0:
        if i>0:
            writer.close()
            k+=1
        train_filename = tf_dst_folder+'kinetics_{}_{}_{:03}.tfrecords'.format(class_target[0].replace(' ','_'), video_base_path.split('/')[
